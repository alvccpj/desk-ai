...
const roleColor: Record<string, string> = {
  ...
  agent: 'badge bg-blue-100 text-blue-700',
  client: 'badge bg-gray-100 text-gray-600',
}
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="text-left px-4 py-3 font-medium text-gray-600">Membro desde</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              {users.map((u) => (
                <tr key={u.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3">
                    <span className={roleColor[u.role] ?? 'badge bg-gray-100 text-gray-600'}>
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`badge ${u.is_active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-600'}`}
                    >
